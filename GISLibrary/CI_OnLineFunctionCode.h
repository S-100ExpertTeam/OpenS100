...
namespace S100 {
	...
	inline std::string CI_OnLineFunctionCodeToString(CI_OnLineFunctionCode category) {
		switch (category) {
	...
	inline CI_OnLineFunctionCode CI_OnLineFunctionCodeFromString(const std::string& categoryName) {
