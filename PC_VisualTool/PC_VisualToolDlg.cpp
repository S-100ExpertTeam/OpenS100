...
BEGIN_MESSAGE_MAP(CPCVisualToolDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CPCVisualToolDlg::OnBnClickedButton1)
END_MESSAGE_MAP()
...
void CPCVisualToolDlg::OnBnClickedButton1()
{
	...
	{
		CString XMLPath= Picker.GetPathName();
		SetDlgItemText(IDC_EDIT1, XMLPath);
	}
}
