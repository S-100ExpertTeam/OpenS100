...
void S100_Path::GetContents(pugi::xml_node node)
{
	...
	for (auto instruction = node.first_child(); instruction; instruction = instruction.next_sibling())
	{
		...
		{
			S100_Annulus* annulus = new S100_Annulus();
