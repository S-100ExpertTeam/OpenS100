...
void S100_Template::SetMatch(const std::string& value)    { match = value; }
void S100_Template::SetMatch(const std::wstring& value)   { match = toUtf8(value); }
void S100_Template::SetPriority(const std::string& value)  { priority = value; }
void S100_Template::SetPriority(const std::wstring& value) { priority = toUtf8(value); }
...
std::string  S100_Template::GetMatch()    { return match; }
std::wstring S100_Template::GetMatchW()   { return toWide(match); }
std::string  S100_Template::GetPriorty()  { return priority; }
std::wstring S100_Template::GetPriortyW() { return toWide(priority); }
