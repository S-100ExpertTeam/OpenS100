...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:template match="ContinentalShelf[@primitive='Point']" priority="1">
      <pointInstruction>
         <featureReference>
   ...
   <xsl:template match="ContinentalShelf[@primitive='Curve']" priority="1">
      <lineInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="ContinentalShelf[@primitive='Surface']" priority="1">
      <lineInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
