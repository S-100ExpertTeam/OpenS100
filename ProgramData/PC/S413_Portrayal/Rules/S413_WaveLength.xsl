...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="WaveLength[@primitive='Point']" priority="1">
    <xsl:call-template name="select_WaveLength">
  ...
  <!--<xsl:template match="S413_WaveLength[@primitive='Point']" priority="1">
    <textInstruction>
      <featureReference>
        <xsl:value-of select="@id"/>
      </featureReference>
