	...
	if feature.PrimitiveType == PrimitiveType.Point and contextParameters.SimplifiedPoints then
		if feature.trafficFlow == 1 and feature.orientationValue[1] then
			...
			if feature.communicationChannel[1] then
				featurePortrayal:AddInstructions('LocalOffset:3.51,-3.51;FontSize:10;TextInstruction:' .. EncodeString(feature.communicationChannel[1], 'ch %s') .. ',11,24')
			end
		...
		elseif feature.trafficFlow == 4 and feature.orientationValue[1] then
			...
			if feature.featureName[1] and feature.featureName[1].name then
				featurePortrayal:AddInstructions('LocalOffset:3.51,3.51;TextAlignVertical:Center;FontSize:10;TextInstruction:' .. EncodeString(GetFeatureName(feature, contextParameters), 'Nr %s') .. ',21,24')
			end
		end
