...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
      ...
      <xsl:include href="TextPlacement.xsl"/>
			<xsl:include href="FoulGround_COMMON.xsl"/>
				<xsl:include href="FoulGround_SYMBOLIZED_BOUNDARIES.xsl"/>
				<xsl:include href="QualityOfBathymetricData_COMMON.xsl"/>
				
			<!--Include templates/rules for: Default-->
			<xsl:include href="Default_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: Default-->
			...
			<xsl:include href="AdministrationArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="CableArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="CautionArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: CautionArea-->
			...
			<xsl:include href="CargoTranshipmentArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: CargoTranshipmentArea-->
			...
			<xsl:include href="DumpingGround_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: DumpingGround-->
			...
			<xsl:include href="Fairway_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: FerryRoute-->
			<xsl:include href="FerryRoute_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: FerryRoute-->
			...
			<xsl:include href="FishingFacility_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: FishingFacility-->
			...
			<xsl:include href="HarbourAreaAdministrative_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="IncinerationArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: IncinerationArea-->
			<xsl:include href="IncinerationArea_COMMON.xsl"/>
			<!--Include templates/rules for: InshoreTrafficZone-->
			<xsl:include href="InshoreTrafficZone_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="LocalMagneticAnomaly_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: LocalMagneticAnomaly-->
			...
			<xsl:include href="MarineFarmCulture_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: MarineFarmCulture-->
			<xsl:include href="MarineFarmCulture_COMMON.xsl"/>
			<!--Include templates/rules for: MilitaryPracticeArea-->
			<xsl:include href="MilitaryPracticeArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: MilitaryPracticeArea-->
			...
			<!--Include templates/rules for: MooringWarpingFacility-->
			<xsl:include href="MooringWarpingFacility_PAPER_CHART.xsl"/>
			...
			<xsl:include href="LocalDirectionOfBuoyage_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="Obstruction_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: Obstruction-->
			...
			<xsl:include href="PilotBoardingPlace_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: PilotBoardingPlace-->
			...
			<xsl:include href="SubmarinePipelineArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: SubmarinePipelineArea-->
			...
			<xsl:include href="PrecautionaryArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: PrecautionaryArea-->
			...
			<xsl:include href="RecommendedTrack_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: RecommendedTrack-->
			<xsl:include href="RecommendedTrack_COMMON.xsl"/>
			<!--Include templates/rules for: RestrictedArea-->
			<xsl:include href="RestrictedArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: RestrictedArea-->
			...
			<xsl:include href="Sandwave_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: Sandwave-->
			...
			<xsl:include href="SeaplaneLandingArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: SeaplaneLandingArea-->
			...
			<xsl:include href="SubmarineTransitLane_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: SweptArea-->
			<xsl:include href="SweptArea_SYMBOLIZED_BOUNDARIES.xsl"/>
			...
			<xsl:include href="TwoWayRoutePart_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: T_HMON-->
			<xsl:include href="T_HMON_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: T_HMON-->
			<xsl:include href="T_HMON_COMMON.xsl"/>
			<!--Include templates/rules for: T_NHMN-->
			<xsl:include href="T_NHMN_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: T_NHMN-->
			<xsl:include href="T_NHMN_COMMON.xsl"/>
			<!--Include templates/rules for: T_TIMS-->
			<xsl:include href="T_TIMS_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: T_TIMS-->
			...
			<xsl:include href="Wreck_SYMBOLIZED_BOUNDARIES.xsl"/>
			<!--Include templates/rules for: Wreck-->
