...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
   ...
   <xsl:template match="BuoySpecialPurposeGeneral[@primitive='Point' and (buoyShape=5 or buoyShape=8)]" priority="3">
      <pointInstruction>
         <featureReference>
            <xsl:value-of select="@id"/>
         </featureReference>
   ...
   <xsl:template match="BuoySpecialPurposeGeneral[@primitive='Point']" priority="1">
      ...
      <xsl:call-template name="FloatingTopmark">
         <xsl:with-param name="featureReference" select="@id"/>
         <xsl:with-param name="viewingGroup">27025</xsl:with-param>
         <xsl:with-param name="displayPlane">OVERRADAR</xsl:with-param>
