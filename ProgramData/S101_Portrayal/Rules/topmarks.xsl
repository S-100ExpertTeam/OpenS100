...
<!-- The topmark symbol is generated from the calling template by calling it like this 
			...
			<xsl:with-param name="topmarkDaymarkShape"><xsl:value-of select="topmarkDaymarkShape"/></xsl:with-param>
			</xsl:call-template>
			-->
	...
	<xsl:param name="topmarkDaymarkShape"/> <!-- the enumeration code for topmark shape  -->
