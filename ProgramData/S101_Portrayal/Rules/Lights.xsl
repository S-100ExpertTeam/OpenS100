...
<xsl:transform xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:key name="NonSectoredLights" match="/Dataset/Features/LightAllAround | /Dataset/Features/LightAirObstruction | /Dataset/Features/LightFogDetector " use="Point/@ref"/>
	...
	<xsl:template match="LightAllAround[@primitive = 'Point' and (categoryOfLight = '11' or categoryOfLight = '8') ]" priority="1">
        <pointInstruction>
			<featureReference><xsl:value-of select="@id"/></featureReference>
            <viewingGroup>27070</viewingGroup>
            <displayPlane>OVERRADAR</displayPlane>
	...
	<xsl:template match="LightAllAround[@primitive = 'Point' and categoryOfLight = '9']" priority="1">
        <pointInstruction>
			<featureReference><xsl:value-of select="@id"/></featureReference>
            <viewingGroup>27070</viewingGroup>
            <displayPlane>OVERRADAR</displayPlane>
