...
function Berth(feature, featurePortrayal, contextParameters)
	...
	elseif feature.PrimitiveType == PrimitiveType.Curve then
		...
		featurePortrayal:AddInstructions('PointInstruction:BRTHNO01')
		featurePortrayal:AddInstructions('LocalOffset:0,0;TextAlignHorizontal:Center;TextAlignVertical:Center;FontSize:10;TextInstruction:' .. EncodeString(GetFeatureName(feature, contextParameters), 'Nr %s') .. ',29,24')
