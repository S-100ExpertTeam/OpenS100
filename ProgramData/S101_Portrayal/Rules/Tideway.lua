...
function Tideway(feature, featurePortrayal, contextParameters)
	...
	elseif feature.PrimitiveType == PrimitiveType.Surface then
		...
		if feature.featureName[1] and feature.featureName[1].name then
			featurePortrayal:AddInstructions('LocalOffset:0,0;TextAlignHorizontal:Center;TextAlignVertical:Center;FontSize:10;TextInstruction:' .. EncodeString(GetFeatureName(feature, contextParameters)) .. ',25,24')
		end
	else
